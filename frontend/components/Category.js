  ...
  return (
    <div>
      <div className="container flex flex-row justify-around px-6">
        <div
          className="px-1 cursor-pointer pt-1 pb-6 border-[1px] border-[#DDDDDD] rounded-md ml-14 "
          onClick={() => handleCategoryClick("Men Oversized T Shirts ")}
        >
          <Image
        ...
        <div
          className="px-1 cursor-pointer pt-1 pb-6 border-[1px] border-[#DDDDDD] rounded-md"
          onClick={() => handleCategoryClick("Pick Printed T Shirts ")}
        >
          <Image
        ...
        <div
          className="px-1 cursor-pointer pt-1 pb-6 border-[1px] border-[#DDDDDD] rounded-md"
          onClick={() => handleCategoryClick("Best Selling Co Ord Sets ")}
        >
          <Image
        ...
        <div
          className="px-1 cursor-pointer pt-1 pb-6 border-[1px] border-[#DDDDDD] rounded-md"
          onClick={() => handleCategoryClick("Fashion Joggers Men ")}
        >
          <Image
        ...
        <div
          className="px-1 cursor-pointer pt-1 pb-6 border-[1px] border-[#DDDDDD] rounded-md"
          onClick={() => handleCategoryClick("Mens Shorts Collection ")}
        >
          <Image
        ...
        <div
          className="px-1 cursor-pointer pt-1 pb-6 border-[1px] border-[#DDDDDD] rounded-md mr-14"
          onClick={() => handleCategoryClick("Plus Size T Shirts ")}
        >
          <Image
