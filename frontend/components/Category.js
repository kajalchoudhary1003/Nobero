  ...
  return (
    <div>
      <div className="container flex flex-row justify-around px-6">
        <div className="px-1 pt-1 pb-6 border-[1px] border-[#DDDDDD] rounded-md ml-14">
          <Image
        ...
        <div className="px-1 pt-1 pb-6 border-[1px] border-[#DDDDDD] rounded-md">
          <Image
        ...
        <div className="px-1 pt-1 pb-6 border-[1px] border-[#DDDDDD] rounded-md mr-14">
          <Image
